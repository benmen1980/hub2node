...
router.get('/',function(req,res){
    res.send('This service works only with POST method, Make sure to post credentials in the below format: <br>' + '"ORDNAME":"IV123456",' + JSON.stringify( helper.getCredentails()));
});
...
async function webSDK(req) {
    try {
        ...
        procWordTemplate = await procedure.wordTemplates;

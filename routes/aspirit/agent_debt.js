...
router.post('/', async function (req, res) {
    ...
    try {
        ...
        // Start procedure
        let procStepResult = await priority.procStart('ITBO_AGNDEBTCUST', 'P', null, req.body.credentials.profile.company);
        ...
        const data3 = {
            EditFields: [
                ...
                { field: 3, op: 0, value: procStepResult.input.EditFields[2].value},
